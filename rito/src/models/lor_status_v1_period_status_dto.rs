...
pub struct LorStatusV1PeriodStatusDto {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "titles")]
    pub titles: Vec<crate::models::LorStatusV1PeriodContentDto>,
    #[serde(rename = "updates")]
    pub updates: Vec<crate::models::LorStatusV1PeriodUpdateDto>,
...
impl LorStatusV1PeriodStatusDto {
    pub fn new(
        id: i32,
        maintenance_status: MaintenanceStatus,
        incident_severity: IncidentSeverity,
        titles: Vec<crate::models::LorStatusV1PeriodContentDto>,
        updates: Vec<crate::models::LorStatusV1PeriodUpdateDto>,
        created_at: String,
        archive_at: String,
        updated_at: String,
        platforms: Vec<Platforms>,
    ) -> LorStatusV1PeriodStatusDto {
        LorStatusV1PeriodStatusDto {
            id,
            maintenance_status,
            incident_severity,
