...
#[serde(untagged)]
pub enum LorDeckV1PeriodCreateDeckError {
    Status400(),
    Status401(),
    Status403(),
    Status404(),
...
/// struct for typed errors of method [`lor_deck_v1_period_get_decks`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum LorDeckV1PeriodGetDecksError {
    Status400(),
    Status401(),
    Status403(),
    Status404(),
...
pub async fn lor_deck_v1_period_create_deck(
    ...
    local_var_req_builder = local_var_req_builder.json(&lor_deck_v1_period_new_deck_dto);
