...
pub async fn spectator_v4_period_get_current_game_info_by_summoner(
    configuration: &configuration::Configuration,
    encrypted_summoner_id: &str,
) -> Result<
    crate::models::SpectatorV4PeriodCurrentGameInfo,
    Error<SpectatorV4PeriodGetCurrentGameInfoBySummonerError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SpectatorV4PeriodGetCurrentGameInfoBySummonerError> =
...
pub async fn spectator_v4_period_get_featured_games(
    configuration: &configuration::Configuration,
) -> Result<
    crate::models::SpectatorV4PeriodFeaturedGames,
    Error<SpectatorV4PeriodGetFeaturedGamesError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SpectatorV4PeriodGetFeaturedGamesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
