...
pub async fn tft_match_v1_period_get_match(
    configuration: &configuration::Configuration,
    match_id: &str,
) -> Result<crate::models::TftMatchV1PeriodMatchDto, Error<TftMatchV1PeriodGetMatchError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TftMatchV1PeriodGetMatchError> =
...
pub async fn tft_match_v1_period_get_match_ids_by_puuid(
    configuration: &configuration::Configuration,
    puuid: &str,
    start: Option<i32>,
    end_time: Option<i64>,
    ...
    count: Option<i32>,
) -> Result<Vec<String>, Error<TftMatchV1PeriodGetMatchIdsByPuuidError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TftMatchV1PeriodGetMatchIdsByPuuidError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
